...
export async function useOption() {
    ...
    program
        ...
        .option("-i, --ignore <ignore>", "ignore file or folder, default: ['node_modules']")
        .option("-e, --ext <ext>", "check file suffix, default: ['.vue', '.js', '.tsx', '.ts']")
    ...
    const options = Object.assign({}, defaultOptions, program.opts());
    const result = {
